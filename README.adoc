= COSMO – iSAQB® Advanced Level Curriculum (COSMO)

== Status

### This document is a DRAFT - Work is in progresss.
Feel free to contact the https://github.com/tasel[authors] and give feedback.

image:https://github.com/isaqb-org/curriculum-cosmo/actions/workflows/build_main.yml/badge.svg?branch=main["CI – Releases and Main"]
image:https://img.shields.io/github/last-commit/isaqb-org/curriculum-cosmo/main.svg["Last commit"]
...
Pages at https://public.isaqb.org/curriculum-cosmo[public.isaqb.org/curriculum-cosmo].
...
[source,shell]
----
git clone git@github.com:isaqb-org/curriculum-cosmo.git --recursive
----
